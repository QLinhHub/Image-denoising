...
parser.add_argument('--sigmas', default=20, type=int, help='noise level')
...
save_dir = os.path.join('models', args.model+'_' + 'sigmas' + str(sigmas))
...
if __name__ == '__main__':
    ...
    for epoch in range(initial_epoch, n_epoch):
        ...
        DDataset = DenoisingDataset(xs, sigmas)
